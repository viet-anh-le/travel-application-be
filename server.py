...
async def life_span(app: FastAPI):
    try:
        ...
        app.state.parent_document_retriever = ParentDocumentRetriever(
            docstore=docstore,
        ...
        raise RuntimeError(
            f"Failed to create vector_store/Chroma repository/Flashrank compressor/Database connection at start up: {e}"
        )
