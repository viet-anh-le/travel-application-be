...
from schemas.schedule_type import CreateScheduleRequest, UpdateScheduleRequest, GoogleCalendarEventRequest
...
class ScheduleService:
    ...
    async def get_all(self, page: int = 1, limit: int = 10):
        ...
        return success_response("Get all schedules successfully", {
            "docs": results,
            "pagination": {
    ...
    async def get_by_user_id(
        ...
        return success_response("Get all schedules by user successfully", {
            "docs": results,
            "pagination": {
                "totalDocs": total_docs,
                "limit": limit,
    ...
    async def create_event_google_calendar(self, schedule_id: str, user_id: str, events: List[GoogleCalendarEventRequest]):
        ...
        try:
            start_date_str = schedule.start_date.strftime("%d/%m/%Y") if schedule.start_date else "N/A"
